...
#endif
#ifdef i386
  defun(ctx,"DOUBLE-BYTESTRING2FVECTOR",mod,DSTRING2FV);
  defun(ctx,"FVECTOR2DOUBLE-BYTESTRING",mod,FV2DSTRING);
  defun(ctx,"LONG-LONG-BYTESTRING2IVECTOR",mod,LSTRING2IV);
  defun(ctx,"IVECTOR2LONG-LONG-BYTESTRING",mod,IV2LSTRING);
#endif
  }
