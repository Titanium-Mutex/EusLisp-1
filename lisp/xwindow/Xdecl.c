...
static pointer F66c_long_long65();
static pointer F67set_c_long_long65();
static pointer F68c_long();
static pointer F69set_c_long();
static pointer F71c_int_integer70();
static pointer F72set_c_int_integer70();
static pointer F73c_int();
static pointer F74set_c_int();
...
/*c-long*/
static pointer F68c_long(ctx,n,argv,env)
register context *ctx;
register int n; register pointer argv[]; pointer env;
{ register pointer *local=ctx->vsp, w, *fqv=qv;
  numunion nu;
...
/*set-c-long*/
static pointer F69set_c_long(ctx,n,argv,env)
register context *ctx;
register int n; register pointer argv[]; pointer env;
{ register pointer *local=ctx->vsp, w, *fqv=qv;
  numunion nu;
...
/*c-int*/
static pointer F73c_int(ctx,n,argv,env)
register context *ctx;
register int n; register pointer argv[]; pointer env;
{ register pointer *local=ctx->vsp, w, *fqv=qv;
  numunion nu;
...
/*set-c-int*/
static pointer F74set_c_int(ctx,n,argv,env)
register context *ctx;
register int n; register pointer argv[]; pointer env;
{ register pointer *local=ctx->vsp, w, *fqv=qv;
  numunion nu;
...
IF318:
	...
	ctx->vsp=local+0;
	compfun(ctx,fqv[159],module,F68c_long,fqv[174]);
	ctx->vsp=local+0;
	compfun(ctx,fqv[175],module,F69set_c_long,fqv[176]);
	local[0]= fqv[159];
	local[1]= fqv[175];
	local[2]= fqv[168];
	ctx->vsp=local+3;
	...
	ctx->vsp=local+0;
	compfun(ctx,fqv[177],module,F73c_int,fqv[183]);
	ctx->vsp=local+0;
	compfun(ctx,fqv[184],module,F74set_c_int,fqv[185]);
	local[0]= fqv[177];
	local[1]= fqv[184];
	local[2]= fqv[168];
	ctx->vsp=local+3;
